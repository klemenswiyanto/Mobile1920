package com.github.klemenswiyanto
...
import com.github.klemenswiyanto.databinding.ActivityMainBinding

class MainActivity : AppCompatActivity() {

    private lateinit var binding: ActivityMainBinding

    private val DefLoremIpsum: MyData = MyData("LoremIpsum", "Lorem Ipsum is simply " +
    ...
    private val LoremIpsumSource: MyData = MyData("Source-LoremIpsum", "There are many " +
    ...
    private val LoremIpsumComeFrom: MyData = MyData("History-LoremIpsum", "Contrary to" +
    ...
    private val LoremIpsumUse: MyData = MyData("Why use-LoremIpsum", "It is a long established" +
